...
//    └───────────────┴───┼──────┼──────┼──────┼─────┼──────────┘   └──────────┼─────┼──────┼──────┼──────┼───┴─────────────┘
//                        │ lctl │ lgui │ lalt │ spc │                         │ ent │ bspc │ rgui │ lctl │
//                        └──────┴──────┴──────┴─────┘                         └─────┴──────┴──────┴──────┘
[_BASE] = LAYOUT(
  ...
  KC_LSFT          , KC_Z , KC_X    , KC_C    , KC_V    , KC_B   , MO(_SYM) ,     MO(_NAV) , KC_N   , KC_M    , KC_COMM , KC_DOT  , KC_SLSH , KC_RSFT          ,
                            KC_LCTL , KC_LGUI , KC_LALT , KC_SPC ,                           KC_ENT , KC_BSPC , KC_RGUI , KC_LCTL
),
...
[_SYM] = LAYOUT(
  ...
  KC_TRNS , KC_CIRC , KC_MINS , KC_PLUS , KC_EQL  , KC_BSLS , KC_TRNS ,     KC_TRNS , KC_LBRC , KC_RBRC , KC_LCBR , KC_RCBR , KC_SLSH , KC_TRNS,
