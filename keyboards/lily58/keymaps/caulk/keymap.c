...
//    ├───────────────┼───┼──────┼──────┼──────┼─────┤                         ├─────┼──────┼──────┼──────┼───┼─────────────┤
//    │ LT(_NAV, esc) │ a │  s   │  d   │  f   │  g  │                         │  h  │  j   │  k   │  l   │ ; │ LT(_SYM, ') │
//    ├───────────────┼───┼──────┼──────┼──────┼─────┼──────────┐   ┌──────────┼─────┼──────┼──────┼──────┼───┼─────────────┤
//    │     lsft      │ z │  x   │  c   │  v   │  b  │ TT(_SYM) │   │ TT(_NAV) │  n  │  m   │  ,   │  .   │ / │    rsft     │
//    └───────────────┴───┼──────┼──────┼──────┼─────┼──────────┘   └──────────┼─────┼──────┼──────┼──────┼───┴─────────────┘
...
[_BASE] = LAYOUT(
  ...
  LT(_NAV, KC_ESC) , KC_A , KC_S    , KC_D    , KC_F    , KC_G   ,                           KC_H   , KC_J    , KC_K    , KC_L    , KC_SCLN , LT(_SYM, KC_QUOT),
  KC_LSFT          , KC_Z , KC_X    , KC_C    , KC_V    , KC_B   , TT(_SYM) ,     TT(_NAV) , KC_N   , KC_M    , KC_COMM , KC_DOT  , KC_SLSH , KC_RSFT          ,
...
[_NAV] = LAYOUT(
  ...
  KC_TRNS       , KC_F9   , KC_F10  , KC_F11  , KC_F12  , KC_PAUS , KC_TRNS ,     KC_TRNS , LCTL(KC_LEFT) , KC_DQUO , KC_BSLS , LCTL(KC_RGHT) , KC_PIPE , KC_TRNS,
                            KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS ,                         KC_TRNS       , KC_BSPC , KC_DEL  , KC_TRNS
),
...
[_SYM] = LAYOUT(
  ...
  KC_TRNS , KC_MINS , KC_PLUS , KC_EQL  , KC_PIPE , KC_BSLS , KC_TRNS ,     KC_TRNS , KC_LCBR , KC_RCBR , KC_LBRC , KC_RBRC , KC_BSLS , KC_TRNS,
